-- AI Information Aggregator - PlanetScale Compatible MySQL Schema
-- Note: PlanetScale doesn't support foreign key constraints, so we rely on application-level referential integrity
